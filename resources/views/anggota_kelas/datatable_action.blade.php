<div class="btn-group">
    ...
    @if (Auth::user()->isAdmin())
        <a href="#" onclick="deleteModel(`{{ route('anggota_kelas.destroy', $anggota_kelas->id) }}`)" class="btn btn-sm btn-danger" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Hapus Dari Kelas" style="margin-right: 5px"><b> Hapus</b></a>
    @endif
</div>