        ...
        return Datatables::of($anggota_kelas)
            ...
            ->addColumn('action', function ($anggota_kelas) {
                ...
                return
                    ...
                    '<a href="' . route('anggota_kelas.show', $anggota_kelas->id) . '" class="btn btn-info" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Show" style="margin-right: 5px" ><i class="menu-icon fa fa-info"></i></a>' .
