        ...
        return Datatables::of($anggota_kelas)
            ...
            ->addColumn('action', function ($anggota_kelas) {
                ...
                return
                    ...
                    '<a href="' . route('siswa.show', $anggota_kelas->siswa->id) . '" class="btn btn-warning" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Show" style="margin-right: 5px" ><i class="menu-icon fa fa-pencil-alt"></i></a>' .
