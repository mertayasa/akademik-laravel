    ...
    static public function set($nilai)
    {
        ...
        return Datatables::of($nilai)
            ...
            ->addColumn('action', function ($nilai) {
                ...
                return
                    '<div class="btn-group">' .
                    '<a href="' . route('nilai.edit', $nilai->id) . '" class="btn btn-warning" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit" style="margin-right: 5px" ><i class="menu-icon fa fa-pencil-alt"></i></a>' .
